...
//			rs.put(RS_CONTENT, responseContent);
	...
	public static String httpClientPostString(String url, String body, int timeout)
	{
		...
		return httpClientPostString(httpclient, url, timeout, body);
	}
	 ...
	 * @return
	 */
	public static String httpClientPostString(CloseableHttpClient httpclient, String url, int timeout, String dataString)
	{
