...
###### 请求url:
https://127.0.0.1:8080/login/loginByMobile.htm
###### 参数:
...
https://127.0.0.1:8080/login/loginByMobile.htm?userName=18061661297&password=123456abc&verifyCode=xx
...
###### 请求url:
https://127.0.0.1:8080/login/loginByOpenId.htm
###### 参数:
...
https://127.0.0.1:8080/login/loginByOpenId.htm?openId=123123123&token=123456abc&channelType=1
