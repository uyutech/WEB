...
###### 请求url:
http://127.0.0.1:8080/register/sendRegSms.json
###### 参数:
mobile 手机号 

##### 接口示例：

http://127.0.0.1:8080/register/sendRegSms.json?mobile=18061661296
...
###### 请求url:
http://127.0.0.1:8080/register/registerByMobile.json
###### 参数:
mobile 手机号 
...
http://127.0.0.1:8080/register/registerByMobile.json?mobile=18061661297&password=123456abc&verifyCode=178651
